...
import { UpdateExampleComponent } from './components/crud/crud-update-example/crud-update-example.component';
import { ReadExampleComponent } from './components/crud/crud-read-example/crud-read-example.component';
import { DeleteExampleComponent } from './components/crud/crud-delete-example/crud-delete-example.component';
...
export const routes: Routes = [
    ...
    {path: 'crud-example/read', component: ReadExampleComponent, canActivate: [authGuard]},
    {path: 'crud-example/update', component: UpdateExampleComponent, canActivate: [authGuard]},
    {path: 'crud-example/delete', component: DeleteExampleComponent, canActivate: [authGuard]},
